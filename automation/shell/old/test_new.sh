...
mkdir ~/couchDB/data
mkdir ~/couchDB/etc/
mkdir ~/couchDB/etc/local.d
#rm /home/ubuntu/couchDB/etc/local.d/*
echo ""
echo "Creating ini file "
touch ~/couchDB/etc/local.d/1.ini
echo ""
...
docker create --net=host -p 5984:5984 --volume ~/couchDB/data:/opt/couchdb/data --volume ~/couchDB/etc/local.d:/opt/couchdb/etc/local.d  apache/couchdb:2.1.1
echo ""
