...
for id in dbn2:
	if id.startswith("_"):
		...
		dbn2.delete(dbn2[id])
dbn2.save(doc2)
print"Counting Distinct users done"



langcitydit = {'Adelaide':{},'Alice Springs':{},'Brisbane':{},'Canberra':{},'Hobart':{},'Mackay':{},'Melbourne':{},'Perth':{},'Sydney':{},'Wollongong':{},'Gold Coast':{}, 'New Castle':{}}
...
#Different languages used by the users to tweet
d4 = "language"
if d4 in server:
    dbn4 = couch[d4]
else:
    dbn4 = couch.create(d4)
...
print "crime analysis takes some time"
