...
class StreamListener(tweepy.StreamListener):
    ...
    def on_data(self, data):
        try:
            ...
            sentiment_score = get_sentiment_score(json_data["text"], tweet_lang)
            if sentiment_score is None:
                document = {"tweet_data": json_data, "sentiment": 'No sentiment found'}
            else:
                document = {"tweet_data": json_data, "sentiment": sentiment_score}
